...
example:
	...
	8) Bank0 Secure APP Code:                             0K (0x0415F000)
	9) Bank0 Secure APP Data:                             0K (0x0415F000)
	10) Bank1 Secure APP Code:                            0K (0x0415F000)
	11) Bank1 Secure APP Data:                            0K (0x0415F000)
	12) RO DATA1:                                         0K (0x0415F000)
	13) RO DATA2:                                         0K (0x0415F000)
	14) RO DATA3:                                         0K (0x0415F000)
	15) RO DATA4:                                         0K (0x0415F000)
	16) RO DATA5:                                         0K (0x0415F000)
	17) RO DATA6:                                         0K (0x0415F000)
	18) OTA Tmp:                                       1024K (0x0415F000)
	19) FTL:                                             16K (0x0425F000)
	20) user data1:                                       0K (0x040FF000)
	21) user data2:                                       0K (0x040FF000)
	22) user data3:                                       0K (0x040FF000)
	23) user data4:                                       0K (0x040FF000)
	24) user data5:                                       0K (0x040FF000)
	25) user data6:                                       0K (0x040FF000)
	26) user data7:                                       0K (0x040FF000)
	27) user data8:                                       0K (0x040FF000)
	29) APP Defined Section1:                            64K (0x04263000)
	2:) APP Defined Section2:                             0K (0x04273000)
*/
...
#define BKP_DATA1_ADDR                  0x04263000
#define BKP_DATA1_SIZE                  0x00010000  //64K Bytes
#define BKP_DATA2_ADDR                  0x04273000
