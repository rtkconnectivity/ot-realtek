...
example:
	...
	7) OTA Bank1:                                      1332K (0x0415F000)
		a) OTA Header                    4K (0x0415F000)
		b) System Patch code            32K (0x04160000)
		c) BT Stack Patch code          60K (0x04168000)
		d) BT Host code                212K (0x04177000)
		e) APP code                   1024K (0x041AC000)
		f) APP Config File               0K (0x042AC000)
		g) APP data1                     0K (0x042AC000)
		h) APP data2                     0K (0x042AC000)
		i) APP data3                     0K (0x042AC000)
		j) APP data4                     0K (0x042AC000)
		k) APP data5                     0K (0x042AC000)
		l) APP data6                     0K (0x042AC000)
	8) Bank0 Secure APP Code:                             0K (0x042AC000)
	9) Bank0 Secure APP Data:                             0K (0x042AC000)
	10) Bank1 Secure APP Code:                            0K (0x042AC000)
	11) Bank1 Secure APP Data:                            0K (0x042AC000)
	12) RO DATA1:                                         0K (0x042AC000)
	13) RO DATA2:                                         0K (0x042AC000)
	14) RO DATA3:                                         0K (0x042AC000)
	15) RO DATA4:                                         0K (0x042AC000)
	16) RO DATA5:                                         0K (0x042AC000)
	17) RO DATA6:                                         0K (0x042AC000)
	18) OTA Tmp:                                          0K (0x042AC000)
	19) FTL:                                             16K (0x042AC000)
	20) user data1:                                       0K (0x042B0000)
	21) user data2:                                       0K (0x042B0000)
	22) user data3:                                       0K (0x042B0000)
	23) user data4:                                       0K (0x042B0000)
	24) user data5:                                       0K (0x042B0000)
	25) user data6:                                       0K (0x042B0000)
	26) user data7:                                       0K (0x042B0000)
	27) user data8:                                       0K (0x042B0000)
	29) APP Defined Section1:                            64K (0x042B0000)
	2:) APP Defined Section2:                             0K (0x042C0000)
*/
...
#define BANK1_OTA_HDR_ADDR              0x0415F000
#define BANK1_OTA_HDR_SIZE              0x00001000  //4K Bytes
#define BANK1_SYSTEM_PATCH_ADDR         0x04160000
#define BANK1_SYSTEM_PATCH_SIZE         0x00008000  //32K Bytes
#define BANK1_BT_STACK_PATCH_ADDR       0x04168000
#define BANK1_BT_STACK_PATCH_SIZE       0x0000F000  //60K Bytes
#define BANK1_BT_HOST_ADDR              0x04177000
#define BANK1_BT_HOST_SIZE              0x00035000  //212K Bytes
#define BANK1_APP_ADDR                  0x041AC000
#define BANK1_APP_SIZE                  0x00100000  //1024K Bytes
#define BANK1_APP_CONFIG_FILE_ADDR      0x042AC000
#define BANK1_APP_CONFIG_FILE_SIZE      0x00000000  //0K Bytes
#define BANK1_APP_DATA1_ADDR            0x042AC000
#define BANK1_APP_DATA1_SIZE            0x00000000  //0K Bytes
#define BANK1_APP_DATA2_ADDR            0x042AC000
#define BANK1_APP_DATA2_SIZE            0x00000000  //0K Bytes
#define BANK1_APP_DATA3_ADDR            0x042AC000
#define BANK1_APP_DATA3_SIZE            0x00000000  //0K Bytes
#define BANK1_APP_DATA4_ADDR            0x042AC000
#define BANK1_APP_DATA4_SIZE            0x00000000  //0K Bytes
#define BANK1_APP_DATA5_ADDR            0x042AC000
#define BANK1_APP_DATA5_SIZE            0x00000000  //0K Bytes
#define BANK1_APP_DATA6_ADDR            0x042AC000
