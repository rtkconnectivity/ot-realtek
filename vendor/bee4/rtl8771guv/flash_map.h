...
example:
    ...
    5) OTA Bank0:                                       260K (0x04012000)
        ...
        e) APP code                    160K (0x0402A000)
        f) APP Config File               0K (0x04052000)
        g) APP data1                     4K (0x04052000)
...
#define BANK0_APP_CONFIG_FILE_ADDR      0x04052000
#define BANK0_APP_CONFIG_FILE_SIZE      0x00000000  //0K Bytes
#define BANK0_APP_DATA1_ADDR            0x04052000
